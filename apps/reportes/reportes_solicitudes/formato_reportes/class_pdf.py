...
class ReporteCandidato(FPDF):
	...
	def header(self):
		...
		ruta = settings.RUTA_STATIC
		self.image(ruta+'/img/tope.png',15,15,250)
	...
	def footer(self):
		...
		self.cell(215,5,'www.visitasclap.bva.org.ve',0,0,'R')  
...
class ReporteFicha(FPDF):
	...
	def header(self):
		...
		# (CAMPO 1 = HORIZONTAL , CAMPO 2 = VERTICAL, CAMPO 3 = DIMENCION DE LA IMAGEN)
		ruta = settings.RUTA_STATIC
		self.image(ruta+'/img/tope.png',15,15,185)
		#Calcular ancho del texto (title) y establecer posición
		#w=self.get_string_width(title)+6
		#self.set_x((210-w)/2)
		#Colores del marco, fondo y texto
